...
async function handleDeleteCategory(id: string) {
  if (!confirm("Bạn có chắc chắn muốn xóa danh mục này? Nó sẽ được đưa vào Thùng rác.")) return;
...
<template>
  <div class="admin-categories-page">
    <div class="page-header mb-8">
      <h1 class="h1-title">Quản lý danh mục</h1>
      <p class="text-muted">Xem cấu trúc phân cấp danh mục sản phẩm dạng cây.</p>
    </div>
    ...
    <div class="categories-layout">
      ...
      <div class="categories-tree-section premium-card">
        <h3 class="section-title border-b">Cấu trúc cây danh mục</h3>
        
        <div v-if="loading" class="text-center py-6 text-muted">Đang tải cấu trúc cây...</div>
        <div v-else-if="categoryTree.length === 0" class="text-center py-6 text-muted">Chưa có danh mục nào.</div>
      ...
      <div class="category-form-section premium-card">
        ...
        <form @submit.prevent="handleSaveCategory" class="category-form">
          ...
          <div class="input-group">
            ...
            <textarea v-model="formDescription" rows="4" class="premium-input text-area-input" placeholder="Mô tả danh mục"></textarea>
          </div>
