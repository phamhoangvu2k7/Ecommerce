...
async function handleCancelOrder(orderId: string) {
  if (!confirm('Bạn có chắc chắn muốn hủy đơn hàng này? Số lượng tồn kho sản phẩm sẽ được cộng trả lại cửa hàng.'))
    return
...
<template>
  <div class="orders-page container">
    ...
    <div v-else class="orders-list">
      <OrderItem v-for="order in orders" :key="order.id" :order="order" @cancel="handleCancelOrder" />
    </div>
  </div>
</template>
